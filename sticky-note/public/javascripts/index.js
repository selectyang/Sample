...
// module
exports.push([module.i, "html, body {\n  margin: 0;\n  height: 100%; }\n\nul, li {\n  margin: 0;\n  padding: 0;\n  list-style: none; }\n\nbody {\n  background: #000 url(http://ourpo1xzl.bkt.clouddn.com/17-8-16/87095815.jpg) repeat top center;\n  font: 14px/1.4 'Arial'; }\n\na {\n  text-decoration: none;\n  color: #fff; }\n\n#header {\n  height: 30px;\n  font-size: 12px; }\n  #header a {\n    display: block;\n    font-size: 12px;\n    margin-top: 6px; }\n  #header .user-area {\n    padding-right: 16px;\n    float: right; }\n    #header .user-area li {\n      float: left;\n      margin-left: 5px; }\n      #header .user-area li span {\n        color: #fff;\n        display: block;\n        margin-top: 6px; }\n    #header .user-area img {\n      height: 18px;\n      margin-top: 5px;\n      border-radius: 50%; }\n  #header .setting {\n    float: right;\n    margin-left: 9px;\n    display: none; }\n  #header .add-note {\n    float: left;\n    margin-left: 16px;\n    border: 1px solid #fff;\n    border-radius: 4px;\n    padding: 2px 4px; }\n  #header .login {\n    float: right;\n    margin-left: 16px; }\n\n#content {\n  position: relative;\n  height: -webkit-calc(100% - 30px);\n  height: calc(100% - 30px); }\n\n@keyframes move-twink-back {\n  from {\n    background-position: 0 0; }\n  to {\n    background-position: -10000px 5000px; } }\n", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./notes.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./notes.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".note {\n  position: absolute;\n  transition: all 0.5s; }\n  .note .note-parent {\n    margin: 20px;\n    transform: rotate(4deg); }\n    .note .note-parent .note-child {\n      position: relative;\n      color: #333;\n      width: 160px;\n      min-height: 150px;\n      margin: 20px 10px;\n      box-shadow: 2px 2px 5px 2px rgba(0, 0, 0, 0.6);\n      transition: all 0.5s; }\n      .note .note-parent .note-child .note-head {\n        cursor: move;\n        text-align: center; }\n        .note .note-parent .note-child .note-head img {\n          height: 30px; }\n        .note .note-parent .note-child .note-head:hover .delete {\n          color: #0f0e0d;\n          opacity: 1; }\n      .note .note-parent .note-child .note-content {\n        padding: 10px;\n        padding-top: 0;\n        outline: none; }\n      .note .note-parent .note-child .delete {\n        position: absolute;\n        top: 4px;\n        right: 4px;\n        font-size: 14px;\n        color: #fff;\n        cursor: pointer;\n        opacity: 0;\n        transition: opacity .3s; }\n\n.draggable {\n  opacity: 0.8;\n  cursor: move;\n  transition: none; }\n", ""]);
