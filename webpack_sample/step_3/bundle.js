...
var app = new _vue2.default({
  ...
  created: function created() {
    ...
    window.onbeforeunload = function () {
      var listString = JSON.stringify(_this.todoList);
      var itemString = JSON.stringify(_this.newTodo);
      window.localStorage.setItem('myTodoList', listString);
      window.localStorage.setItem('myTodo', itemString);
    };
    var oldlistString = window.localStorage.getItem('myTodoList');
    var olditemString = window.localStorage.getItem('myTodo');
    var oldlistData = JSON.parse(oldlistString);
    var olditemData = JSON.parse(olditemString);
